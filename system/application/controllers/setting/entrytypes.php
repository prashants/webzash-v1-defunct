...
class EntryTypes extends Controller {
	...
	function add()
	{
		...
		$data['entry_type_base_types'] = array('1' => 'Normal Entry', '2' => 'Inventory Entry');
	...
	function edit($id)
	{
		...
		switch ($entry_type_data->base_type)
		{
			case 1: $data['base_type'] = 'Normal Entry'; $data['is_normal_entry'] = TRUE; break;
			case 2: $data['base_type'] = 'Inventory Entry'; $data['is_normal_entry'] = FALSE; break;
			default: $data['base_type'] = '(Invalid)'; $data['is_normal_entry'] = TRUE; break;
		}

		switch ($entry_type_data->inventory_entry_type)
		{
