	...
	function check_database()
	{
		...
		if ($CI->db->conn_id)
		{
			...
			if ($CI->db->query("SHOW TABLES"))
			{
				...
				$table_names = array('groups', 'ledgers', 'voucher_types', 'vouchers', 'voucher_items', 'inventory_units', 'inventory_groups', 'inventory_items', 'stock_voucher_items', 'tags', 'logs', 'settings');
