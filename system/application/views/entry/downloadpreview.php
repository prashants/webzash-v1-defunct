...
<head>
<title><?php $current_entry_type['name']; ?> Entry Number <?php echo $voucher_number; ?></title>
...
<body>
	...
	<br />
	<div id="print-voucher-number"><?php echo $current_entry_type['name']; ?> Entry Number : <span class="value"><?php echo full_entry_number($voucher_type_id, $voucher_number); ?></span></div>
	<div id="print-voucher-number"><?php echo $current_entry_type['name']; ?> Entry Date : <span class="value"><?php echo $voucher_date; ?></span></div>
	<br />
