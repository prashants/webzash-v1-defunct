<?php
	...
	echo "Current database version : " . "<strong>" .  $this->config->item('account_database_version') . "</strong><br />";
	echo "</p>";

	echo "<p>";
	echo "<strong><u>Account Information:</u></strong>" . "<br />";
	echo "&nbsp;&nbsp;&nbsp;<strong>Account Label:</strong> " . $this->session->userdata('active_account') . "<br />";
	echo "&nbsp;&nbsp;&nbsp;<strong>Account Name:</strong> " . $this->config->item('account_name') . "<br />";     
	echo "&nbsp;&nbsp;&nbsp;<strong>Financial Year Start:</strong> " . date_mysql_to_php_display($this->config->item('account_fy_start')) . "<br />";
	echo "&nbsp;&nbsp;&nbsp;<strong>Financial Year End:</strong> " . date_mysql_to_php_display($this->config->item('account_fy_end')) . "<br />";
	echo "</p>";
